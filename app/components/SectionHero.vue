<template>
  <section class="flex flex-col-reverse lg:flex-row w-full max-w-screen">
    <section class="flex flex-col justify-center items-start gap-4 lg:gap-7 h-full lg:min-h-dvh w-full max-w-screen">
      ...
      <div class="flex flex-col lg:flex-row gap-3 max-w-screen w-full">
        <Badge class="bg-gruv-fg-500 text-gruv-bg-500">Front-end Developer</Badge>
        <Badge class="bg-gruv-fg-500 text-gruv-bg-500">Vue/Nuxt Developer</Badge>
        <Badge class="bg-gruv-fg-500 text-gruv-bg-500">React Native Developer</Badge>
      </div>
    </section>
    <CoffeeWithCat />
  </section>
