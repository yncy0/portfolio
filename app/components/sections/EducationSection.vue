...
<template>
  <section id="education" class="flex flex-col gap-5 w-full max-w-screen">
    <h2 class="text-lg lg:text-2xl dark:text-ctp-green-200 text-cat-text">Education</h2>
    <UCard class="bg-base-500 text-fg-500 dark:border-ctp-green-200 border-fg-500 border rounded-sm">
